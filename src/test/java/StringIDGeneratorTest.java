...
public class StringIDGeneratorTest {
    ...
    private void testUid(String uidBits, List<Pair<Integer, Integer>> timeAndSequenceBitsCountList) throws Exception{
        ...
        for(Pair<Integer, Integer> timeAndSequenceBitsCount:timeAndSequenceBitsCountList){
            idGenerator = new StringIDGenerator(0,
                    uid,
            ...
            assertThat(idGenerator.generateStringId(), is(not(equalTo(""))));
            Thread.sleep(1);
            assertThat(idGenerator.generateBase64Id(), is(not(equalTo(""))));
            Thread.sleep(1);
            assertThat(idGenerator.generateHexBinaryId(), is(not(equalTo(""))));
            Thread.sleep(1);
            assertThat(idGenerator.generateURLEncodedId(), is(not(equalTo(""))));
